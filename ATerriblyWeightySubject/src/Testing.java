...
public class Testing {
    ...
    @Test
    public void test10Pounds0OuncesToOunces() {
        assertEquals("160 oz", converter.toOunces(10, 0));
    }

    @Test
    public void test5Pounds5OuncesToOunces() {
        assertEquals("85 oz", converter.toOunces(5, 5));
    }
}